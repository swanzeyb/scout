...
exports.android = exports.executeSteps = exports.executeStrategy = exports.textContext = exports.extractTextBlocks = exports.Device = void 0;
...
function androidLoop(App) {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const { device, textReport } = yield setup;
        // On Mount
        yield App({ device, text: [], executeSteps, executeStrategy });
        try {
            // On Update
            for (var textReport_1 = __asyncValues(textReport), textReport_1_1; textReport_1_1 = yield textReport_1.next(), !textReport_1_1.done;) {
                ...
                console.log('OCR Output', text.map(block => block === null || block === void 0 ? void 0 : block.text));
                const finished = yield App({ device, text, executeSteps, executeStrategy });
                if (finished)
                    break;
            }
        }
...
function android(App) {
    return __awaiter(this, void 0, void 0, function* () {
        const { device, textReport } = yield setup;
        const perform = (steps) => __awaiter(this, void 0, void 0, function* () {
            const { value } = yield textReport.next();
            yield executeSteps(device, value, steps);
        });
        yield App({ device, text: textReport, perform });
    });
}
