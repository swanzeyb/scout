...
exports.setMany = exports.has = exports.get = exports.set = exports.subscribe = exports.createDB = void 0;
const env_1 = require("./env");
const mongodb_1 = require("mongodb");
function createDB(database, collection) {
...
function subscribe(database, collection, then) {
    return __awaiter(this, void 0, void 0, function* () {
        const col = yield createDB(database, collection);
